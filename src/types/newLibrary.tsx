...
export interface NewLibraryDataType {
  ID: string;
  // ID_Image: string;
...
export interface NewLibraryModalProps {
  open: boolean;
  mode: "create" | "edit";
  initialValues?: Partial<NewLibraryFormValues> | null;
  onCancel: () => void;
  onSubmit: (values: NewLibraryFormValues) => Promise<void>;
}

export const getNewLibraryColumns = (
  onPreview: (images: (Image | File)[]) => void,
  onView: (record: NewLibraryDataType) => void,
): ColumnsType<NewLibraryDataType> =>
  // {
  // const columns: ColumnsType<NewLibraryDataType> =
  [
    {
      title: "Action",
      key: "action",
